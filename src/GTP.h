...
extern std::array<float, 4> cfg_lambda;
extern std::array<float, 4> cfg_mu;
extern std::string cfg_lambda_default_str;
extern std::string cfg_mu_default_str;
